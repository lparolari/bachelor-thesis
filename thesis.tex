...
essere eseguiti, sono compilati in byte-code. Il compilatore non
trasforma i sorgenti in codice macchina, ma depura il programma da
tutto quello che non è necessario per l'esecuzione, esegue alcuni
...
In questa sezione si dà una panoramica delle funzionalità avanzate in
Picat. Eventuali approfondimenti si possono trovare in \cite{PicatGuide}.
...
proibire l'utilizzo di un predicato da moduli esterni apponendo la
