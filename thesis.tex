...
attributi rappresentati come mappa chiave-valore.\footnote{Gli
  ...
  vincoli integrati in moduli predefiniti di Picat per memorizzare
...
picat> main.
\end{verbatim}
oppure, grazie ad una forma più concisa, in 
...
\begin{itemize}
	...
	\item se visualizzare o meno i messaggi del solver (ad esempio, 
	      i passaggi delle riscritture).
\end{itemize}

Configurazioni di basso livello sono proibite o determinate a
...
alla rappresentazione interna di Picat. Lo schema sottostante riassume
la condizione ottimale in cui la formula non ha bisogno di alcuna
traduzione per essere elaborata dal solver. La soluzione al problema è
...
modo il solver non ha bisogno di modifiche, in quanto il lavoro è
